...
class TestVerify:
    ...
    def test_pkgconfig_resolves(self):
        """pangoft2 is the one that broke: its Requires.private names libthai,
    xft, xrender and harfbuzz-gobject, and the index provided none of the
    first three and half of the fourth. GTK 4 requires pangoft2 whenever
    the x11 or wayland backend is on.
        """
        assert_pkgconfig_resolves("pango", "pangocairo", "pangoft2")
