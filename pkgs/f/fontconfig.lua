package = {
    ...
    xpm = {
        linux = {
            ...
            -- `xim:fontconfig@>=2.15.0.1` for exactly this: pin-to-active
            -- cannot satisfy the floor with an old active 2.15.0, so the
            -- resolver installs this key and install() seals it.
            ["2.15.0.1"] = {
                url = {
