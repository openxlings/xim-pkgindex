-- libcusolver — the NVIDIA CUDA redistributable component `libcusolver`.
--
...
package = {
    ...
    name = "libcusolver",
    description = "CUDA libcusolver: dense and sparse direct solvers",
    ...
    keywords = {"cuda", "nvidia", "gpu", "libcusolver"},
    ...
    xpm = {
        linux = {
            source = "https://developer.download.nvidia.com/compute/cuda/redist/"
                  .. "libcusolver/linux-${arch_alias}/"
                  .. "libcusolver-linux-${arch_alias}-${version}-archive.tar.xz",
            arch_alias = { x86_64 = "x86_64", aarch64 = "sbsa" },
            ["latest"] = { ref = "12.2.2.18" },
            ["12.2.2.18"] = {
                sha256 = {
                    aarch64  = "d10bee9fe0f521125617a653ce9c5934dd59eabd8459b628b6a3bf80baa1bc3a",
                    x86_64   = "100b49bc0b6372fe17c1fea3400dbb4cd12313ad326dea516fa26eb1d20c1a32",
                },
            },
            ["11.7.5.82"] = {
                sha256 = {
                    aarch64  = "db463593ffcbc78f542a7f1ef808da43bf742acae654d970d99a47289c2a83e5",
                    x86_64   = "3d3b96f3087dbc43893a28691b172f31725b316d524f5a3c1e6837257c898d06",
                },
            },
        },
    },
...
function install()
    ...
    if not src then
        error("libcusolver: the downloaded archive did not unpack to a recognisable "
              .. "component directory")
    end
    local dir = pkginfo.install_dir()
    os.tryrm(dir)
    os.mv(src, dir)
    log.info("libcusolver installed to %s", dir)
    return true
end
