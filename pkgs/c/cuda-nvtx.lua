-- cuda-nvtx — the NVIDIA CUDA redistributable component `cuda_nvtx`.
--
...
package = {
    ...
    name = "cuda-nvtx",
    description = "CUDA cuda_nvtx: NVTX ranges for profilers",
    ...
    keywords = {"cuda", "nvidia", "gpu", "cuda_nvtx"},
    ...
    xpm = {
        linux = {
            ...
            source = "https://developer.download.nvidia.com/compute/cuda/redist/"
                  .. "cuda_nvtx/linux-${arch_alias}/"
                  .. "cuda_nvtx-linux-${arch_alias}-${version}-archive.tar.xz",
            arch_alias = { x86_64 = "x86_64", aarch64 = "sbsa" },
            ["latest"] = { ref = "13.3.29" },
            ["13.3.29"] = {
                sha256 = {
                    aarch64  = "7c5bad2972e8d8fb701fe3f3241bdfd04ea6c78bfdc2c1eff04e03eb8d11153a",
                    x86_64   = "7c7c2567e35de98b5bf92bef06b97ccc90cd472ca44b9b1558b25812a54df64e",
                },
            },
            ["12.9.79"] = {
                sha256 = {
                    aarch64  = "dae359c2c51f83a5cd402468f481a82aeb6d32d79dc707d3625607e83cf97ceb",
                    x86_64   = "819bc39192955e6ba2067de39b85f30e157de462945e54b12bfdeda429d793fb",
                },
            },
        },
    },
...
-- The archive unpacks to `cuda_nvtx-linux-<arch>-<version>-archive/`.
...
function install()
    ...
    if not src then
        error("cuda-nvtx: the downloaded archive did not unpack to a recognisable "
              .. "component directory")
    end
    local dir = pkginfo.install_dir()
    os.tryrm(dir)
    os.mv(src, dir)
    log.info("cuda-nvtx installed to %s", dir)
    return true
end
