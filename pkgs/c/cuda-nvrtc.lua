-- cuda-nvrtc — the NVIDIA CUDA redistributable component `cuda_nvrtc`.
--
...
package = {
    ...
    name = "cuda-nvrtc",
    description = "CUDA cuda_nvrtc: runtime compilation of CUDA C++",
    ...
    keywords = {"cuda", "nvidia", "gpu", "cuda_nvrtc"},
    ...
    xpm = {
        linux = {
            ...
            source = "https://developer.download.nvidia.com/compute/cuda/redist/"
                  .. "cuda_nvrtc/linux-${arch_alias}/"
                  .. "cuda_nvrtc-linux-${arch_alias}-${version}-archive.tar.xz",
            arch_alias = { x86_64 = "x86_64", aarch64 = "sbsa" },
            ["latest"] = { ref = "13.3.33" },
            ["13.3.33"] = {
                sha256 = {
                    aarch64  = "d0502b25799be62a50b743c640e94a1722d20b1ee4ab70d697d71750f04d3b8a",
                    x86_64   = "9e8f78278215babd1236b137252424ca7912c185bd093201f5d97f7dd763b74a",
                },
            },
            ["12.9.86"] = {
                sha256 = {
                    aarch64  = "fb2d50c791465f333fc2236d2419170cf7a7886f48dd9b967a10f8233c686029",
                    x86_64   = "82913658363892dbc0f2638b070476234476e06e084fed60db861cb7e161a6af",
                },
            },
        },
    },
...
-- The archive unpacks to `cuda_nvrtc-linux-<arch>-<version>-archive/`.
...
function install()
    ...
    if not src then
        error("cuda-nvrtc: the downloaded archive did not unpack to a recognisable "
              .. "component directory")
    end
    local dir = pkginfo.install_dir()
    os.tryrm(dir)
    os.mv(src, dir)
    log.info("cuda-nvrtc installed to %s", dir)
    return true
end
