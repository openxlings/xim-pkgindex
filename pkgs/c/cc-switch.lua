package = {
    ...
    xpm = {
        linux = {
            ...
            ["latest"] = { ref = "3.16.3" },
            ["3.16.3"] = {
                url = "https://github.com/farion1231/cc-switch/releases/download/v3.16.3/CC-Switch-v3.16.3-Linux-x86_64.AppImage",
                sha256 = "169ab0f0e970152e855eb20856b13e559dee923e6a28c293886701ef980759d6",
            },
            ["3.14.1"] = {
        ...
        macosx = {
            ...
            ["latest"] = { ref = "3.16.3" },
            ["3.16.3"] = {
                url = "https://github.com/farion1231/cc-switch/releases/download/v3.16.3/CC-Switch-v3.16.3-macOS.zip",
                sha256 = "a5834515cc31be9c2cee109cdc52069e5f69a8b55a0fd13b41b6937166119fcd",
            },
            ["3.14.1"] = {
        ...
        windows = {
            ...
            ["latest"] = { ref = "3.16.3" },
            ["3.16.3"] = {
                url = "https://github.com/farion1231/cc-switch/releases/download/v3.16.3/CC-Switch-v3.16.3-Windows-Portable.zip",
                sha256 = "0670fc91b02ea530ebb1db334e252d286ebfe3a5e50d0c88d33a426c2388e7a0",
            },
            ["3.14.1"] = {
